...
@objc public class PermissionScope: UIViewController, CLLocationManagerDelegate, UIGestureRecognizerDelegate, CBPeripheralManagerDelegate {
    ...
    */
    @objc public func addPermission(_ permission: Permission, message: String) {
        ...
        assert(configuredPermissions.first(where:{ $0.type == permission.type }).isNil, "Permission for \(permission.type) already set")
    ...
    */
    public func requestNotifications() {
        ...
        case .unknown:
            ...
            let notificationsPermission = configuredPermissions.first(where: {$0 is NotificationsPermission}) as? NotificationsPermission
